...
This project is a scalable, offline-first code assistant designed to answer questions about your local codebases. It uses a Retrieval-Augmented Generation (RAG) pipeline to provide relevant, context-aware answers by combining semantic vector search with a local LLM, all running on your machine without needing an internet connection.
